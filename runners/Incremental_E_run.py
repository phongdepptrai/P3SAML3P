...
if use_wsl:
    ...
    SCRIPT = f"{WSL_ROOT}/solvers/Incremental_E.py"
    WINDOWS_OUTPUT = "/mnt/c/Users/admin/Documents/Python/P3SAML3P/Output/Incremental_E"
    ...
    SCRIPT = ROOT / "solvers" / "Incremental_E.py"
