...
if use_wsl:
    ...
    SCRIPT = f"{WSL_ROOT}/solvers/IncrementalSM_E_Shorten.py"
    WINDOWS_OUTPUT = "/mnt/c/Users/admin/Documents/Python/P3SAML3P/Output/IncrementalSM_E_Shorten"
    ...
    SCRIPT = ROOT / "solvers" / "IncrementalSM_E_Shorten.py"
